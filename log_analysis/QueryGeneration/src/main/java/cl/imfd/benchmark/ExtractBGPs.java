...
public class ExtractBGPs {
	public static void main(String[] args) throws UnsupportedEncodingException, IOException {
		...
		TreeSet<String> multipleBGPQuery = new TreeSet<String>();
		TreeSet<String> singleBGPQuery = new TreeSet<String>();
		...
		try {
		    ...
		    //   multipleBGPFile.close();
		      singleBGPQueryFile.close();
		      multipleBGPQueryFile.close();
	    } catch (IOException e) {
